...
/* async function addToDatabase(name, age) {
  const uri = 'mongodb+srv://franrenzulli:<password>@cluster0.6x3pqet.mongodb.net/'; // Replace with your actual connection URI
  const client = new MongoClient(uri);
  ...
  try {
    ...
    const database = client.db('database1'); // Specify the database name directly
    const collection = database.collection('users');
